...
const INITIAL_PROFILE = {
  codeName: 'SHADOW-WARDEN',
  name: 'Shrey Patel',
  email: 'shrey@aegisintel.org',
    ...
    <div className="max-w-4xl mx-auto pb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        >
          ...
          {/* Avatar */}
          <div className="relative z-10 w-24 h-24 rounded-full bg-primary/10 border-2 border-primary/50 flex items-center justify-center shadow-[0_0_25px_-5px_var(--color-primary)]">
        ...
        >
          ...
          <div className="mt-6 pt-6 border-t border-border/40 flex items-center gap-2 text-xs font-mono text-muted-foreground/50">
            ...
            Clearance level is assigned by the Network Administrator and cannot be self-modified.
          </div>
        </motion.div>
      </div>
    </div>
